...
- 12267ed: ⬆️ Update `comline` to `0.8.0`, with documented support for `recoverage.config.json`. Set `defaultBranch` once for capture and diff, with command-line options taking precedence.
